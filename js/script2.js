var bonusExpireDates = {
    "1": {
        "name": "Регулярные бонусы за покупки",
        "bonuses": 752,
        "time": [1, 31]
    },
    "2": {
        "name": "Бонусы за покупку акционных товаров",
        "bonuses": 2000,
        "time": [7, 25]
    },
    "3": {
        "name": "Бонусы за покупку от 5000 ₽",
        "bonuses": 1400,
        "time": [15, 20]
    },
    "4": {
...
var generateTimetable = function (timetable) {
    ...
    for (var i in timetable) {
        ...
        timeblock.textContent = timetable[i]["bonuses"] + " б.";
...
generateTimetable(bonusExpireDates);


var checkTask = function () {
    var correctAnswer = 2752;
